...
CREATE TABLE "Parings" (
    ...
    CONSTRAINT "Parings_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Parings" ADD CONSTRAINT "Parings_eventId_fkey" FOREIGN KEY ("eventId") REFERENCES "Event"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Parings" ADD CONSTRAINT "Parings_santaId_fkey" FOREIGN KEY ("santaId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Parings" ADD CONSTRAINT "Parings_personId_fkey" FOREIGN KEY ("personId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
